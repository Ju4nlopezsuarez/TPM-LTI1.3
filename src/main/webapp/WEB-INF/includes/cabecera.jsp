<div class="h1container">
	<h1>
		...
		Administrador de herramientas de correcci�n LTI ${appVersion }
		---
		${mgmtUser.username}
	</h1>
</div>
<div id="aboutdiv">
	<p id="about">
		...
		<img src="../img/dit.gif" alt="Departamento de Ingenier�a Telem�tica" width="35" height="35">
...
<div id="menu">
	<% es.us.dit.lti.entity.MgmtUserType
		...
		<% } 
		/* Menú ADMIN */ 
		if (tipoUsuario==es.us.dit.lti.entity.MgmtUserType.ADMIN || tipoUsuario==es.us.dit.lti.entity.MgmtUserType.SUPER) { %>
